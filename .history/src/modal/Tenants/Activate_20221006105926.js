        ...
        <div className="bg-[#FFFFFF] flex flex-col items-center absolute w-[500px] h-[420px] left-[35%] mt-[10%] rounded-3xl px-6">
            <div className="flex flex-col gap-5 mb-6 mt-14 items-center p-1 text-center">
                ...
                <div className="flex mx-auto  gap-4 items-center ">
                    <div className="flex justify-center gap-2 rounded items-center text-[16px]  bg-[#e9ebea] h-[50px] w-[200px] p-4">
                        <button
                            onClick={() => {
                    ...
                    <div className="flex justify-center gap-2 rounded items-center text-[16px] text-white bg-[#38CB89] h-[50px] w-[200px] p-4">
                        <button
                            onClick={() => {
                                setSuccess(true)
                                changeStatus();
