        ...
        <div className='mt-[30px] h-[800px] rounded-3xl bg-[#F9F9F9] p-8 w-[65%] overflow-y-auto'>
          ...
          <div className='flex gap-4 mt-3 p-6 '>
            ...
            <div className='flex flex-col w-[50%] h-[350px] items-center gap-10'>
              ...
              {userCount &&
                <div className=' bg-[#FFFF] w-full h-[50%] rounded-xl p-3 flex gap-14'>
                  <img src={profIcon} alt=''/>
                  <p className='font-semibold  text-[25px]'> <span className='text-[14px] mb-4'>User Account</span> <br /> <span className='text-[#9FA19C]'>{service.users ? service.users.active : '0'} </span>/{service.users ? service.users.total : '0'}</p>
