            ...
            <div className='flex flex-col w-[50%] h-[350px] items-center gap-10'>
              ...
              {userCount &&
                <div className=' bg-[#FFFF] w-full h-[50%] rounded-xl p-8 items-center flex gap-14'>
                  ...
                  <p className='font-semibold  text-[25px]'> <span className='text-[14px]'>User Account</span> <br /> <span className='text-[#9FA19C]'>{service.users ? service.users.active : '0'} </span>/{service.users ? service.users.total : '0'}</p>
