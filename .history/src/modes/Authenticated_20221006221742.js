        ...
        <div className='bg-[#FFFFFF] text-[#54565B]'>
            ...
            <div className='flex h-[calc(100vh-90px)]'>
                ...
                <Routes>
                    ...
                    <Route path="/products" element={<Products setList={setPlist} productsLoaded={productsLoaded} setProductsLoaded={setProductsLoaded} setModal={setModal} />} />
                    <Route path="/productlist" element={<Productlist list={plist} setViewFilter={setViewFilter} setProductsLoaded={setProductsLoaded} productsLoaded={productsLoaded} setModal={setModal} />} />
