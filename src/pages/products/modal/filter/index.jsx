      ...
      <div
        ...
        <form action='' className='my-10'>
          <div className='flex flex-col gap-8'>
            <select
              id='type'
              className="className='bg-[#38CB89] w-full py-3 border-b-2 text-[#151615] text-[16px] px-5">
            ...
            <select
              id='type'
              className="className='bg-[#38CB89] w-full py-3 border-b-2 text-[#151615] text-[14px] px-5">
