                ...
                <div className='mt-[30px] h-[800px] rounded-3xl bg-[#F9F9F9] p-8 w-[65%] overflow-y-auto'>
                    ...
                    <div className='p-3 rounded-3xl w-full mt-8 bg-[#FFFF]'>
                        ...
                        <div className='flex justify-between p-3 border-b '>
                            ...
                            <div className='flex flex-col gap-5 mb-6 items-center p-1 text-center'>
                                ...
                                <div className='flex justify-center gap-2 rounded items-center text-[12px] text-white bg-[#38CB89] h-[40px] w-[142px] p-4'>

                                    <button>
                                        Upload
                                    </button>
                                    <img src={recieptIcon} alt='' className='w-[200px]'/>
