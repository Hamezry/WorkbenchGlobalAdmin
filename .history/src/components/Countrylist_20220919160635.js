    ...
    return (
        <div className='w-[85%] font-muli h-[calc(100vh-90px)] p-1'>
            ...
            <div className='w-[100%] h-[calc(100%-10%)] rounded-2xl p-10 bg-[#F9F9F9] overflow-y-auto'>
                ...
                <div className='bg-[#FFFFFF] h-[700px] rounded-3xl w-[100%] py-3 px-8'>
...

                                {
                                    list?.data?.map((item, index) => {
                                        return (
                                            ...
                                            <tr key={index} class=" text-center border-b border-gray-200 hover:bg-[#e3f7ee]">
                                                ...
                                                <td class="py-3 px-6 bg-gray-200 ">
                                                    <div className='overflow-x-hidden truncate w-[70px] h-[50px]' > <span class="font-medium ">{item.available_commodities}</span> </div>
