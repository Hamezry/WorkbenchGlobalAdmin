...
const Select = ({ data, defaultValue, className, updateValue }) => {
  ...
  return (
    <div className='relative'>
      <button
        className={`relative flex items-center py-2 px-2 child:px-1 child:whitespace-nowrap  border border-gray-50 bg-gray-50  text-base rounded-lg cursor-pointer ${className} ${
