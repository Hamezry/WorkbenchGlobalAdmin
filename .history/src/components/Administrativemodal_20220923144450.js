    ...
    return (
        <div className='w-[100vw] font-muli h-[100vh] bg-[rgba(50,59,75,0.7)] fixed z-50 top-0 left-0'>
            ...
            <div className='bg-[#FFFFFF] flex flex-col items-center gap-6 absolute w-[600px] h-[490px] left-[38%] mt-[8%] rounded-3xl px-10'>
                ...
                <div className='w-full flex flex-col items-center gap-6 h-[253px] bg-[#f8f8f9] border border-gray-700 border-dotted rounded-3xl '>

                    <img src={cloudicon } alt=''className='mt-6'/>
