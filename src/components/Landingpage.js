                ...
                <form action="" class="my-10">
                    <div class="flex flex-col space-y-5">
                        <label for="email">
                            ...
                            <input id="email" name="email" type="email" class="w-full py-3 border text-[#9FA19C] text-[14px] rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Username"/>
                        </label>
                        <label for="password">
                        ...
                        <button  class="w-full py-3 font-medium text-white bg-[#38CB89] rounded-lg hover:shadow inline-flex space-x-2 items-center justify-center">
                           <Link to='/authenticated'> <span>Sign In</span> </Link> 
                        </button>
                        <p class="text-center">Create an account for your organization <br/> <span>Data Privacy Policy</span></p>
                    </div>
                </form>
