            ...
            <div className='flex flex-col w-[50%] h-[350px] items-center gap-10'>
              ...
              {userCount &&
                <div className=' bg-[#FFFF] w-full h-[50%] rounded-xl p-8 items-center flex gap-14'>
                  ...
                  <p className='text-[25px]'> <span className='text-[14px]'>User Account</span> <br /> {service.users ? service.users.active : '0'}/{service.users ? service.users.total : '0'}</p>
                  <div className="flex gap-3 ">
                    <button ><FaLessThan className="h-[50px]"/></button>
                    <button onClick={() => {
                      setUserCount(false);
                      setStorageCount(true);
                    }}><FaGreaterThan className="h-[50px]" /></button>
                  </div>
                </div>
              }

              {
                ...
                <div className=' bg-[#FFFF] w-full h-[50%] rounded-xl p-8 items-center flex gap-14'>
                  ...
                  <p className='text-[25px]'> <span className='text-[14px]'>Storage Capacity (MT)</span> <br /> {service.storage_capacity ? service.storage_capacity.total_capacity : '0'}/{service.storage_capacity ? service.storage_capacity.total_utilization : '0'}</p>
                  <div className="flex gap-3 ">
                    <button onClick={() => {
                      setUserCount(true);
                      setStorageCount(false);
                    }} ><FaLessThan className="h-[50px]" /></button>
                    <button><FaGreaterThan className="h-[50px]" /></button>
                  </div>
                </div>
