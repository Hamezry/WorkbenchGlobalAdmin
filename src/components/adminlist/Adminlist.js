  ...
  const settingModal = async (pk) => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        setModalData({ ...modalData, title: res.data.message, data: temp });
      })
                  ...
                  <div className='pl-2'>
                    ...
                    <div className='flex pt-6'>
                      <div className=' pr-14 border-r border-r-gray-200'>
                        <p>{position.lng} </p>
                        <p className='text-xs text-afexgreen pt-2'>Longitude</p>
                      </div>

                      <div className=' pl-14'>
                        <p>{position.lat} </p>
                        <p className='text-xs text-afexgreen pt-2'>Latitude</p>
                      </div>
                    </div>
                  </div>{" "}
                </div>
                  ...
                  <div className='whitespace-normal text-textgrey text-start'>
                    ...
                    <form
                      ...
                      <div className='pb-7 child:capitalize'>
                        <label className='px-2 pb-3 block'>Location name</label>
                        <input
                          type='text'
