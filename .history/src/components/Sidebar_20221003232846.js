  ...
  return (
    <div className="sticky flex flex-col font-muli left-0 w-[16%] bg-[#FFFFFF] h-[calc(100vh-90px)] border-none">
      <div classname="overflow-x-hidden text-[#8B908B] h-full border-r-1 flex flex-col">
        <ul classname="flex flex-col border-gray-600 border-r-2 h-[100%] mr-6 p-6">
          <li className="mt-4">
          ...
          <button
            ...
            className={
              navlink === "tenants"
                ...
                : "flex items-center border-r-4 border-[#38CB89] hover:bg-[#e2f8ee] w-full mt-4"
            }
          >
          ...
          <button
            ...
            className={
              navlink === "products"
                ...
                : "flex w-full border-r-4 border-[#38CB89] hover:bg-[#e2f8ee] items-center mt-4 "
            }
          >
            <li className="flex gap-4 items-center p-2">
              <span>
          ...
          <button
            ...
            className={
              navlink === "country"
                ...
                : "w-full flex items-center border-r-4 border-[#38CB89] hover:bg-[#e2f8ee] mt-4"
            }
          >
            <li className="flex  gap-4 items-center p-2">
              <span>
