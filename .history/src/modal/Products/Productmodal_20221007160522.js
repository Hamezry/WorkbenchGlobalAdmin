...
function Productmodal({ setModal }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        const resp = await axios.post(url, { name: productName, product_type: productType, unit_type: unitType, code: productVolume, certified: certified });

        console.log(resp)
        
        console.log(JSON.stringify({ name: productName, product_type: productType, unit_type: unitType, code: productVolume, certified: certified }))
        setModal(false)
    };
                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        <label>
                            ...
                            >
                                ...
                                <option value="MT">Metric Tone</option>
                            </select>
                        ...
                        {/* <div className='self-center'>
                            ...
                            <button className='w-full py-3 font-medium text-white bg-[#38CB89] rounded-lg hover:shadow inline-flex space-x-2 items-center justify-center' type="submit"
                            >
                                Submit
                            </button>
                        {/* </Link> */}
