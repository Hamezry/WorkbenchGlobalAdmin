...
const Authenticated = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://wb-temp.afexnigeria.com/WB3/api/v1/countries`, options)
            .then(res => {
                setCountry(res.data)
                //console.log(res.data)
                setTotalFarmers(res.data?.summary?.total_farmers)
            }).catch(err => {
                console.log(err)
            })
    });
        ...
        <div className='bg-[#FFFFFF] text-[#54565B]'>
            ...
            <div className='flex h-[calc(100vh-90px)]'>
                ...
                <Routes>
                    ...
                    <Route path="/country/:id" element={<Country setViewAdminModal={setViewAdminModal} country={country} setCountry={setCountry} totalFarmers ={totalFarmers} />} />
