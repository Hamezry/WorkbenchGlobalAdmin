    ...
    return (
        <div className="bg-[#FFFFFF] flex flex-col items-center absolute w-[500px] h-[420px] left-[35%] mt-[10%] rounded-3xl px-6">
            <div className="flex flex-col gap-5 mb-6 mt-14 items-center p-1 text-center">
                ...
                <div className="flex justify-center w-full gap-4 bg-red-300 items-center ">
                    <button className='text-[15px] w-auto flex items-center text-center text-gray-500 bg-[#eff1f1] rounded h-[40px]  p-5'
                        onClick={() => {
                            setViewActivate(false)
                        }}>
                        Cancel
                    </button>
                    <button className='text-[15px] w-full flex items-center text-center text-white bg-[#38CB89] rounded h-[40px] p-5'
                        onClick={() => {
                            setSuccess(true)
                            changeStatus();
                        }}>
