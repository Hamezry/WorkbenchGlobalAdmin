    ...
    return (
        <div className='w-[100vw] font-muli h-[100vh] bg-[rgba(50,59,75,0.7)] fixed z-50 top-0 left-0'>
            ...
            <div className='bg-[#FFFFFF] absolute w-[450px] h-[700px] left-[38%] mt-[8%] rounded-3xl px-10'>
                ...
                <form action="submit" className="my-10">
                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        {/* <div className='self-center'>
                            ...
                            <button className='w-[400px] py-3 font-medium text-white bg-[#38CB89] rounded-lg hover:shadow inline-flex space-x-2 items-center justify-center' type="submit"
