...
function Productlist({ list, setViewFilter, setModal,  setDeactivateProduct, setProductsLoaded, productsLoaded }) {
                  ...
                  currentPosts?.filter((item) =>
                    ...
                    return (
                      ...
                      <tr key={index} className="text-left border-b border-gray-200 hover:bg-[#e3f7ee]">
                        ...
                        <td className="py-5 px-6">
                          < Dropdown  setDeactivateProduct={ setDeactivateProduct} />
                        </td>
