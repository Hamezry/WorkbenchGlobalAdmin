...
function Organisationlist() {
    ...
    return (
        <div className="w-[85%] flex flex-col bg-[#FFFFFF] gap-14 font-muli h-[calc(100vh-90px)]  overflow-y-auto px-3">

            {/*TENANT STATISTICS*/}
            <div className="w-full bg-[#F9FAFB] mt-[5%] rounded-3xl text-[20px] p-5 items-center gap-3">
                <p>Tenants</p>
            ...
            <div className=" h-[calc(100vh-5%)] bg-[#F9FAFB] rounded-3xl">
