                ...
                <tbody>
                  <tr className="bg-[#FBFBFB] lg:hover:bg-[#e3f7ee] flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                    ...
                    <td className="w-full lg:w-auto p-3 text-gray-800 border border-b text-center block lg:table-cell relative lg:static">
                      {transaction.data.uploaded_balance.total_gross_weight}
                    </td>
                    <td className="w-full lg:w-auto p-3 text-gray-800 border border-b text-center block lg:table-cell relative lg:static">
                    {transaction.data.uploaded_balance.total_net_weight}
                    </td>
                    <td className="w-full lg:w-auto p-3 text-gray-800 border border-b text-center block lg:table-cell relative lg:static">
                    {transaction.data.uploaded_balance.total_units}
                    </td>
                  </tr>
                      ...
                      return (
                        <tr className="text-left border-b border-gray-200 hover:bg-[#e3f7ee]">
                          ...
                          <td className="py-4 px-2">
                            ...
                            <span className="font-medium ">{item.location_breakdown.volume}</span>
