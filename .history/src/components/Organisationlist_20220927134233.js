...
function Organisationlist() {
    ...
    return (
        <div className='w-[85%] bg-[#FFFFFF] gap-5 font-muli h-[calc(100vh-90px)] py-7 px-1'>

            {/*TENANT STATISTICS*/}
            <div className='flex items-center w-[100%] mt-8 bg-[#FFFFF] h-[20%] p-4'>

                <div className='w-full bg-[#F9FAFB] text-[20px] items-center gap-3'>
                    <p>Tenants</p>
                    <div className='flex gap-5'>

                        <div className=' bg-[#FFFFFF]  w-[300px] h-[180px]'>
                            <p>Total Active Tenants</p>
                            <p>4,500</p>
                            <p> <span>In-active Tenants:</span>4000</p>
                        </div>
            ...
            {/*TENANTS CONTAINER*/}
            <div className='flex items-center w-[100%] bg-[#F9FAFB] h-[10%] p-4'>
            ...
            <div className='w-[100%] h-[calc(100%-30%)] rounded-2xl p-10 bg-[#F9F9F9] overflow-y-auto'>
