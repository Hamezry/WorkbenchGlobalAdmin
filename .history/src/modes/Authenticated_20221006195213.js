...
const Authenticated = () => {
   ...
   const currentPost = setList.slice(firstPostIndex, lastPostIndex  )
    ...
    useEffect(() => {
        ...
        axios
            .get(`https://wb3test.afexnigeria.com/WB3/api/v1/tenant/global/list?page_size=7&&page=${currentPage}&company_name=Af`, options)
            .then((res) => {
                setList(res.data);
    ...
    return (
        <div className='bg-[#FFFFFF] text-[#54565B]'>
            ...
            <div className='flex h-[calc(100vh-90px)]'>
                <Sidebar />
                <Routes>
                    <Route path="/" element={<Organisationlist list={currentPost} setList={setList} setViewActivate={setViewActivate} setViewDeactivate={setViewDeactivate} openModal={openModal} />} />
