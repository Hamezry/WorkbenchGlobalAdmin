      ...
      <div className="overflow-x-hidden text-[#8B908B] h-full border-r-1 flex flex-col">
        ...
        <ul className="flex flex-col border-r-2 border-r-[#F3F3F3] h-[100%] mr-8 pt-4 pl-6">
          ...
          <button
            ...
            className={
              navlink === "tenants"
                ? "cursor-pointer hover:bg-[#e2f8ee] w-full bg-[#e2f8ee] border-r-4 border-[#38CB89] mt-4 flex items-center rounded-xl "
                : "flex items-center rounded-xl hover:bg-[#e2f8ee] w-full mt-4"
            }
          >
          ...
          <button
            ...
            className={
              navlink === "products"
                ? "cursor-pointer w-full hover:bg-[#e2f8ee] bg-[#e2f8ee] border-r-4 border-[#38CB89] flex mt-4 items-center rounded-xl "
                : "flex w-fullrounded-xl hover:bg-[#e2f8ee] items-center mt-4 "
            }
          >
            <li className="flex gap-2 items-center p-2">
              <span>
          ...
          <button
            ...
            className={
              navlink === "country"
                ? "w-full rounded-xl cursor-pointer hover:bg-[#e2f8ee] bg-[#e2f8ee] border-r-4 border-[#38CB89] flex mt-4 items-center "
                : "w-full rounded-xl flex items-center hover:bg-[#e2f8ee] mt-4"
            }
          >
            <li className="flex  gap-2 items-center p-2">
              <span>
          ...
          <li className="flex mt-4 gap-2 items-center  p-2">
            <span>
