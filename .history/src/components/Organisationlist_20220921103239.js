    ...
    return (
        <div className='w-[85%] font-muli h-[calc(100vh-90px)] p-1'>
            ...
            <div className='w-[100%] h-[calc(100%-10%)] rounded-2xl p-10 bg-[#F9F9F9] overflow-y-auto'>
                ...
                <div className='bg-[#FFFFFF] h-[100%] rounded-3xl w-[100%] py-3 px-8'>
                    ...
                    <div className='px-5 h-[500px] overflow-x-auto'>

                        <table className='min-w-max table-auto overflow-y-auto h-[700px]'>
                            ...
                            <tbody class="text-[#54565B] h-[400px] overflow-y-auto text-[12px] font-light">
                                    ...
                                    list?.data?.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={index} className=" text-left  border-b border-gray-200 hover:bg-[#e3f7ee]">
                                                ...
                                                <td class="py-6 px-4 mr-10">
                                                    <Link to='/organisation'>
                                                        <span class="font-medium">{index + 1}</span>
                                                    </Link>
                                                </td>

                                                <td class="py-6 px-4 mr-10 text-start ">
                                                    <span class="font-medium ">{item.company_name}</span>
                                                </td>

                                                <td class=" flex mt-2 gap-2 py-6 px-4 mr-10">
                                                    <img src={nigerianFlag} alt='' />
                                                    <span class="font-medium ">{item.country.name}</span>
                                                </td>

                                                <td class="py-6 px-4 mr-10 w-[150px]">
