...
function Administrativemodal() {
    return (
        <div className='w-[100vw] font-muli h-[100vh] bg-[rgba(50,59,75,0.7)] fixed z-50 top-0 left-0'>
            ...
            <div className='bg-[#FFFFFF] flex flex-col items-center absolute w-[600px] h-[490px] left-[38%] mt-[8%] rounded-3xl px-6'>

                <div className='flex items-center text-center py-10 w-full'>
                    <p className='text-[18px] w-[80%] self-center'>Upload or Drag and Drop</p>
