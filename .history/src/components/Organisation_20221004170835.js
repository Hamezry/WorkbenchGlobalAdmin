              ...
              {userCount &&
                <div className='relative bg-[#FFFF] w-full h-[50%] rounded-xl  flex gap-10 px-8 items-center'>
                  ...
                  <div className=" absolute right-8 top-8 flex gap-5 ">
                    <button ><FaLessThan className="h-[10px] font-light " /></button>
                    <button onClick={() => {
                      setUserCount(false);
                      setStorageCount(true);
                    }}><FaGreaterThan className="h-[10px]" /></button>
                  </div>
              ...
              {storageCount &&
                <div className='relative bg-[#FFFF] w-full h-[50%] rounded-xl  flex gap-10 px-8 items-center'>
                  ...
                  <div className=" absolute right-8 top-8 flex gap-5 ">
                    ...
                    }}><FaLessThan className="h-[10px] font-light " /></button>
                    <button><FaGreaterThan className="h-[10px]" /></button>
                  </div>
