...

                                    {
                                        country?.data?.map((item, index) => {
                                            return (
                                                ...
                                                <tr key={index} class=" text-left text-[15px] border-b border-gray-200 py-6 hover:bg-[#e3f7ee]">
                                                    ...
                                                    <td class=" flex mt-2 gap-2 py-6 px-6 w-[190px]">
                                                        <Link to='/country' className='flex gap-3'>
                                                            <img src={item.country_flag} className="w-[22px] h-[15px] rounded" alt='' />
