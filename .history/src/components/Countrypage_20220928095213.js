...
function Countrypage() {
    return (
        <div className='w-[85%] flex flex-col gap-14 font-muli h-[calc(100vh-90px)] overflow-y-auto'>
            ...
            <div className="h-[calc(100%-3%)] bg-yellow-300">
                ...
                <div className='w-full h-[calc(100%-10%)] rounded-2xl p-6 bg-[#F9F9F9]'>
                    ...
                    <div className='bg-[#FFFFFF] flex justify-around p-5 rounded-3xl'>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='w-[300px] h-[350px] rounded-2xl p-8  mt-[95%] bg-[#F9F9F9]'>
