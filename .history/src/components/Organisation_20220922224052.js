...
function Organisation() {
  ...
  const token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgwODYyNTE3LCJpYXQiOjE2NjM1ODI1MTcsImp0aSI6IjYyMmQ5NzAxY2U1NjQ4NDBhOTAyNmExN2FjYjhmNDM4IiwidXNlcl9pZCI6Impva2Fmb3IiLCJlbWFpbCI6Impva2Fmb3JAYWZleG5pZ2VyaWEuY29tIn0.szo9wLbMsm4GZoct4c_eWtlbG-IEZygusdUStw6df9M'
          ...
          <div className='flex gap-4 mt-3 p-6 '>
            ...
            <div className='flex flex-col w-[50%] h-[350px] items-center gap-10'>
              ...
              <div className=' bg-[#FFFF] w-full h-[50%] rounded-xl p-8 items-center flex gap-14'>
                ...
                <p className='text-[25px]'> <span className='text-[14px]'>Warehouse Count</span> <br /> {service.service_list.warehouse_count}</p>
              </div>
