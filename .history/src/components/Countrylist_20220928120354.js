...
function Countrylist() {
    ...
    return (
        <div className='w-[85%] flex flex-col gap-14 font-muli h-[calc(100vh-90px)] bg-[#FFFF] overflow-y-auto '>
            ...
            <div className="bg-[#F9F9F9] h-[calc(100%-10%)] rounded-3xl">
                ...
                <div className='w-[100%] h-[calc(100%-10%)] rounded-2xl p-10 bg-[#F9F9F9] overflow-y-auto'>
                    ...
                    <div className='flex flex-col gap-2 bg-[#FFFFFF] h-[100%] rounded-3xl w-[100%] py-3 px-8'>
                        ...
                        <div className='flex justify-between p-1 rounded-2xl bg-[#F9F9F9] items-center'>
