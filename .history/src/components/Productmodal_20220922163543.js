                ...
                <div className='flex flex-col gap-8'>
                    ...
                    <label for="type">
                       ...
                       <p class="text-[14px] text-[#54565B] pb-2">Type</p>
                        ...
                        <select id="type" class="w-full py-3 border-none active:bg-[#F1F2F3] text-[#9FA19C] text-[14px] rounded-lg px-5 focus:outline-none focus:border-slate-500 hover:shadow">
