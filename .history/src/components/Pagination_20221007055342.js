...
const Pagination = ({ setCurrentPage }) => {
    return (
        <div className='my-2 w-[80%] mx-auto flex items-center justify-end'>
            <div
                className={setCurrentPage === 1 ? 'bg-gray-500 rounded cursor-pointer p-3' : 'bg-gray-300 rounded cursor-pointer text-black p-3'}
                onClick={() => {
                    if (setCurrentPage !== 1)
