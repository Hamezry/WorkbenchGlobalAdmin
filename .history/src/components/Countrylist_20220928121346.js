...
function Countrylist() {
    ...
    return (
        <div className='w-[85%] flex flex-col gap-14 font-muli h-[calc(100vh-90px)] bg-[#FFFF] overflow-y-auto '>
            ...
            <div className="bg-[#F9F9F9]  p-6 h-[calc(100%-10%)] rounded-3xl">
                ...
                <div className='w-[100%] h-[calc(100%-10%)] rounded-2xl p-5 bg-[#F9F9F9] overflow-y-auto'>

                    <div className='flex flex-col gap-1 bg-[#7f3f3f] h-[100%] rounded-3xl w-[100%] py-3 px-8'>
                                        ...
                                        list?.data?.map((item, index) => {
                                            return (
                                                ...
                                                <tr key={index} class=" text-left border-b border-gray-200 hover:bg-[#e3f7ee]">
                                                    ...
                                                    <td class=" flex mt-2 gap-2 py-3 px-6 w-[190px]">
                                                        <Link to='/country'>
