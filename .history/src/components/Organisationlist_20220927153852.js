...
function Organisationlist() {
    ...
    return (
        <div className="w-[85%] flex flex-col bg-[#FFFFFF] gap-14 font-muli h-[calc(100vh-90px)]  overflow-y-auto">
            ...
            {/*TENANT STATISTICS*/}
            <div className="w-full flex flex-col bg-[#F9FAFB] mt-[5%] rounded-3xl text-[20px] gap-3 p-5">
                <p>Overview</p>

                {/*CARDS */}
                <div className="flex p-5 justify-evenly">

                    <div className=" flex flex-col p-5 gap-5 bg-[#FFFFFF] rounded-3xl w-[300px] h-[180px]">
                        <p className="text-[#47494E] text-[16px]">Total Active Tenants</p>
                        <p className="text-[20px]">4,500</p>
