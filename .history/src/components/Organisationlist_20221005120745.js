                    ...
                    <div className="bg-[#FFFFFF] rounded-3xl w-[100%] py-4 px-8">
                        ...
                        <div className="flex justify-between items-center pl-5 gap-5">
                            ...
                            <div className="flex justify-end items-center p-5 gap-5">
                                ...
                                <div class=" flex gap-2 p-3 rounded-2xl text-sm  text-gray-300 bg-[#F9F9F9] h-[54px">
                                    <p>Date Registered</p>
                                    <svg
                                        className="fill-current h-4 w-4"
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        class="w-full p-3 rounded-2xl text-sm text-[text-gray-700] border-none outline-none focus:outline-none bg-[#F9F9F9] h-[54px w-[360px]"
