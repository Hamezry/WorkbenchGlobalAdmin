            ...
            <div className='flex flex-col w-[50%] h-[350px] items-center gap-10'>
              ...
              {userCount &&
                <div className='relative bg-[#FFFF] w-full h-[50%] rounded-xl  flex gap-10 px-8 items-center'>
                  ...
                  <div className=" absolute right-8 top-8 flex gap-5 ">
                    <button ><FaLessThan className="h-[15px] font-light " /></button>
                    <button onClick={() => {
                      setUserCount(false);
                      setStorageCount(true);
                    }}><FaGreaterThan className="h-[15px]" /></button>
                  </div>
              ...
              {storageCount &&
                <div className='relative bg-[#FFFF] w-full h-[50%] rounded-xl  flex gap-10 px-8 items-center'>
                  ...
                  <div className='font-semibold text-[25px]'>
                    <p className='text-[14px] mb-5'>Storage Capacity (MT)</p>
                  ...
                  <div className=" absolute right-8 top-8 flex gap-5 ">
                    ...
                    }}><FaLessThan className="h-[15px] font-light " /></button>
                    <button><FaGreaterThan className="h-[15px]" /></button>
                  </div>
