...
function Productlist({ setViewFilter, setModal }) {
  ...
  return (
    <div className='w-[85%] relative font-muli bg-[#FFFFFF] h-[calc(100vh-90px)] overflow-y-auto'>
      ...
      <div className=' flex justify-between items-center w-full rounded py-8 px-8 bg-[#F9F9F9] text-[#54565B] text-[14px]'>
...

                {
                  list?.data?.map((item, index) => {
                    ...
                    return (
                      ...
                      <tr key={index} className="text-center border-b border-gray-200 hover:bg-[#e3f7ee]">
                        ...
                        <td className="py-5 px-6">
                          <span className="font-medium ">{item.product_typ}</span>
                        </td>
