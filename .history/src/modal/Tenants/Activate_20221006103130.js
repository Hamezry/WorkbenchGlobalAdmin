        ...
        <div className="bg-[#FFFFFF] flex flex-col items-center absolute w-[500px] h-[420px] left-[35%] mt-[10%] rounded-3xl px-6">
            <div className="flex flex-col gap-5 mb-6 mt-14 items-center p-1 text-center">
                ...
                <div className="flex mx-auto w-full gap-4 bg-red-300 items-center ">
                    <div className=' bg-[#eff1f1] w-[200px]'>
                        <button className='text-[15px] w-auto flex items-center text-center text-gray-500 rounded h-[40px] p-5'
                            onClick={() => {
                    ...
                    <div className='bg-[#38CB89] w-[200px]'>

                        <button className='text-[15px] self-center flex items-center text-center text-white  rounded h-[40px] p-5'
                            onClick={() => {
                                setSuccess(true)
                                changeStatus();
                            }}>
