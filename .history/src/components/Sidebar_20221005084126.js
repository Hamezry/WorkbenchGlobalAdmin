...
function Sidebar() {
  ...
  return (
    <div className="sticky flex flex-col font-muli left-0 w-[16%] bg-[#FFFFFF] h-[calc(100vh-90px)]">
      <div classname="overflow-x-hidden bg-[#4a2626] text-[#8B908B] h-full border-r-1 flex flex-col">
        <ul classname="flex flex-col border-r-4 border-[#38CB89] h-[100%] mr-6 p-6">
          <li className="mt-4">
