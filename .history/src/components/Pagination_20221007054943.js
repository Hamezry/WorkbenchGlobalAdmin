...
const Pagination = ({ setCurrentPage }) => {
    return (
        <div className='my-4 w-[80%] mx-auto flex items-center justify-end'>
            <div
                className={setCurrentPage === 1 ? 'text-slate-300 cursor-pointer p-3' : 'cursor-pointer text-black p-3'}
                onClick={() => {
                    if (setCurrentPage !== 1)
            ...
            <div
                className={setCurrentPage === 6 ? 'bg-green-400 p-3 cursor-pointer' : 'bg-green-400 p-3 cursor-pointer text-black'}
                onClick={() => {
                    if (setCurrentPage !== 6)
                        return (setCurrentPage + 1)
                }}
