    ...
    return (
        <div className='bg-[#FFFFFF] text-[#54565B]'>
            ...
            <div className='flex h-[calc(100vh-90px)]'>
                <Sidebar />
                <Routes>
                    <Route path="/" element={<Organisationlist list={list} setList={setList} setViewActivate={setViewActivate} />} />
            ...
            {viewActivate && <Activatemodal setViewActivate={setViewActivate} />}
